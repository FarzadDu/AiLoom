...
export function GET(request: Request) {
  ...
  const allowed = new Set<MediaOperation>([
    "text_to_image", "image_edit", "image_inpaint", "character_to_image", "image_upscale", "text_to_video", "image_to_video", "reference_to_video", "temporal_inpaint", "text_to_speech", "text_to_music", "text_to_sound_effect"
  ]);
