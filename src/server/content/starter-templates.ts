...
/** Editable recipes. Auto image stages use image edit when a reference is present. */
  ...
  },
  {
    ...
    definition: {
      ...
      steps: [
        ...
        { id: "anchor", title: "Create anchor portrait", kind: "image", prompt: "Make a natural, detailed portrait of {{subject}} in {{scene}}. Keep defining facial features, hairstyle and age presentation consistent with the supplied reference. Use realistic light and anatomy; avoid adding extra people or text." },
  ...
  },
  {
    ...
    definition: {
      ...
      steps: [
        ...
        { id: "frame", title: "Make key frame", kind: "image", prompt: "Create a cinematic first frame for {{story}}. Visual style: {{style}}. Show clear subject placement, environment and lighting suitable for the start of a short moving shot. No captions or watermarks." },
  ...
  },
  {
    ...
    definition: {
      ...
      steps: [
        ...
        { id: "voice-script", title: "Write voiceover", kind: "chat", modelId: "openrouter/auto", prompt: "Write only the spoken words for a concise voiceover announcing {{offer}} to {{audience}}. Match this brand voice: {{brand}}. Use the earlier hook, and return one or two sentences without directions, labels or quotation marks." },
        { id: "voice", title: "Add voiceover take", kind: "audio", modelId: "fal-ai/elevenlabs/tts/eleven-v3", prompt: "{{previous}}" }
      ]
    }
  }
];
